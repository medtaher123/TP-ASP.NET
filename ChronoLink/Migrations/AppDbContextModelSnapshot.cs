...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ChronoLink.Models.Calendar", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("ChronoLink.Models.Event", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("ChronoLink.Models.Calendar", b =>
                {
                    ...
                    b.HasOne("ChronoLink.Models.Workspace", "Workspace")
                        .WithOne("SharedCalendar")
                        .HasForeignKey("ChronoLink.Models.Calendar", "WorkspaceId")
            ...
            modelBuilder.Entity("ChronoLink.Models.Event", b =>
                {
                    b.HasOne("ChronoLink.Models.Calendar", "Calendar")
                        .WithMany("Events")
            ...
            modelBuilder.Entity("ChronoLink.Models.Workspace", b =>
                {
                    b.HasOne("ChronoLink.Models.User", "Admin")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("ChronoLink.Models.User", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
